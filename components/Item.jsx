...
const Item = ({title ,price ,  img  , slug }) => {
  
  const router = useRouter()
  return (
    <div
    className={ `shrink-0 flex-none h-[143px] w-[105px] border-2 border-darkYellow  lg:w-[313px] lg:h-[427px]`}  onClick={()=> router.push(`/product/${slug}`)} >
